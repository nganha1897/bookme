    ...
    <div className="row wrapper">
      <div className="col-10 col-lg-8">
        ...
        >
          ...
          <div className="mb-3">
            <label htmlFor="room_type_field" className="form-label">Category</label>
            <select
          ...
          <div className="row">
            <div className="mb-3 col">
              <label htmlFor="guest_field" className="form-label">Guest Capacity</label>
              <select
                className="form-select"
                id="guest_field"
                name="guestCapacity"
          ...
          {roomFeatures?.map((feature) => (
            <div className="form-check">
              <input
                ...
                onChange={onChange}
              />
              <label className="form-check-label" htmlFor={feature.name}>{feature.name}</label>
            </div>
          ))}
