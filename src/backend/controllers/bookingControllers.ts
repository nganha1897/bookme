...
// Get total sales and number of bookings for each month in the last six months
...
// Get top 3 rooms with the highest number of bookings in the date range
...
// Get booking details => /api/admin/bookings
export const allAdminBookings = catchAsyncErrors(
